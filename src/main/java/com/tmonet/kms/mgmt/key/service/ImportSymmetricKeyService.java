...
@Service
public class ImportSymmetricKeyService {

//	private static final Logger logger = LoggerFactory.getLogger(ImportSymmetricKeyService.class);
	...
	public HsmImportSymmetricKeyRequest makeHsmImportSymmetricKeyRequestData(ImportSymmetricKeyRequest request,
			String partitionId, List<KeyProfileAttrListVo> keyProfileAttrList) {
		try {
			HsmImportSymmetricKeyRequest reqData = new HsmImportSymmetricKeyRequest();
			ApiInfo apiInfo = new ApiInfo();
			apiInfo.setApiId("HSM.SK.REG.02");
			...
			reqData.setSymmetricKeyData(request.getSymmetricKeyData());
