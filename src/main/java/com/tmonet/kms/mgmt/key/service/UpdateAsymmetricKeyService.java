...
@Service
public class UpdateAsymmetricKeyService {
...
//		String keyPairId = "";
//		List<KeyAttrListVo> keyAttrList = selectKeyAttrList(keyList);
//		for (KeyAttrListVo vo : keyAttrList) {
//			switch (vo.getATTR_ID()) {
//				case "keyPairId":
//					keyPairId = vo.getVALUE();
//					break;
//			}
//		}
//		if (keyPairId.isEmpty()) {
//			throw new KMSException(KMSErrorCode.UNAVAILABLE_STATUS);
//		}
	}
	...
	public void updateAsymmetricKeyInfo(String profileId, String oldKeyId, String newKeyId, HsmServiceInfoVo hsmGroupInfo,
