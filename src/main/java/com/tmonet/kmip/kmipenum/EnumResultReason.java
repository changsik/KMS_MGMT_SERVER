...
public class EnumResultReason extends KMIPEnumeration{
	...
	public static final int BadCryptographicParameters          = 0x24;
	public static final int IllegalObjectType                   = 0x28;
	public static final int InternalServerError                 = 0x2A;
	
	public static final int UnsupportedCryptographicParameters  = 0x3E;
